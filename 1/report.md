...
| ввод. пробелы в начале           | `  1`<br>`  1`                 | `+0.1E+1`          |
| ввод. пробелы в конце            | `1  `<br>`1  `                 | `+0.1E+1`          |
...
| ввод числителя с минусом         | `-6`<br>`2`                    | `-0.2E+1`          |
| ввод числителя с плюсом          | `+6`<br>`2`                    | `+0.2E+1`          |
| ввод знаменталя с минусом        | `6`<br>`-2`                    | `-0.2E+1`          |
| ввод знаменталя с плюсом         | `6`<br>`+2`                    | `+0.2E+1`          |
| деления отриц. числ. и знам.     | `-6`<br>`-2`                   | `+0.2E+1`          |
...
| ввод 29 цифр после 0.            | `0.<0 28 раз>8`<br>`2`         | `+0.4E-27`         |
...
| ввод 30 цифр после .             | `.<0 29 раз>8`<br>`2`          | `+0.4E-28`         |
