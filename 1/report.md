...
Операции над числами можно осуществить, используя классические методы вычислений, например, умножение "столбиком", деление "уголком". Можно использовать приблеженные методы, например, Ньютона-Рафсона, которые быстрее, но менее точные и более сложные в реализации.
